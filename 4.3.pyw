"""
Welcome to Cipherer 4.3!
Upgrades:
1.Progressing interface
2.Home background
Algorithm:v1.5
"""
...
def _help():
    msgbox('Help', 'Welcome to Cipherer 4.3!\n\
...
def start():
    progress = Tk()
    progress.geometry('200x150+400+225')
    ...
    canvas.create_text(223, 113, text='Cipherer', fill='LightGray',
                       font=('Times New Roman Baltic', 50))
    canvas.create_text(220, 110, text='Cipherer', fill='Blue',
                       font=('Times New Roman Baltic', 50))
