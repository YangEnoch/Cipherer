...
def _enc():
    try:
        ...
        messagebox.showerror('Error', 'Encrypt Error')
...
def _dec():
    try:
        ...
        messagebox.showerror('Error', 'Decrypt Error')
...
def _encc():
    try:
        ...
        messagebox.showerror('错误', '加密时出现错误')
...
def _decc():
    try:
        ...
        messagebox.showerror('错误', '解密时出现错误')
